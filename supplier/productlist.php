            ...
            <table class="table tablesorter " id="page1">
              ...
              <tbody>
                ...
                $result = mysqli_query($con, "
                                    SELECT 
                                        p.product_id,
                                        c.cat_title AS product_cat,
                                        p.product_image,
                                        b.brand_title AS product_brand,
                                        p.product_title,
                                        p.product_price,
                                        p.product_discount
                                    FROM 
                                        products p
                                    JOIN 
                                        categories c ON p.product_cat = c.cat_id
                                    JOIN 
                ...
                while (list($product_id, $product_cat, $image, $product_brand, $product_name, $price, $discount) = mysqli_fetch_array($result)) {
                  echo "<tr>
                                            ...
                                            <td>$discount</td>
                                            <td>
                                                <a href='editproduct.php?product_id=$product_id' type='button' rel='tooltip' title='' class='btn btn-info btn-link btn-sm' data-original-title='Edit Proudct'>
